...
const getAdminRoute = () => {
    if (props.permission.includes("users.view")) return route("users");
    else if (props.permission.includes("roles.view")) return route("roles");
    else if (props.permission.includes("classes.view")) return route("classes");
